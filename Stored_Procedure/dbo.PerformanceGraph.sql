...
BEGIN   
    ...
    CPULoad AS  
    (
        SELECT      TOP (256)                                               AS [SQL Server Process CPU Utilization],  
                    y.SQLProcessUtilization                                 AS [System Idle Process],   
                    y.SystemIdle                                            AS [Other Process CPU Utilization],   
                        ...
                        = STUFF(
                          (
                                SELECT      ','
                                            ...
                                            + ' ' + CAST(CPULoad.[SQL Server Process Utilization] AS VARCHAR(20))    
    ...
    BEGIN            
        ...
        (geometry::Parse('LINESTRING(' + @CPUPtherOut + ')'), 'CPU-Other'),   
